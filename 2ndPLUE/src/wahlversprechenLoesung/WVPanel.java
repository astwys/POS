...
/** Panel f�r die Eigenschaften eines Wahlversprechens
 */
public class WVPanel extends JPanel
{
	...
	/** Erzeugt das Panel 
	 * 
	 * @param eingabebereit false: alle Komponenten werden unver�nderbar angezeigt
	 *                      true: Felder sind Eingabebereit (siehe auch hinzufuegen)
	 * @param hinzufuegen   true: zum Hinzuf�gen ... alle Komponenten sind einabebereit
	 *                      false zum �ndern     ... das Feld Schlagwort ist nicht ver�nderbar
	 */
	...
	{	this.setLayout(new GridLayout(6,2));
		...
		wVP.add(new JLabel("wird nach Wahl ung�ltig:"));
		wVP.add(wirdVerworfen);
		gueltig = new JCheckBox("Wahlversprechen noch g�ltig");
