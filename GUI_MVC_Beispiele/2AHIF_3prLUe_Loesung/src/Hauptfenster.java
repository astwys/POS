...
public class Hauptfenster extends JFrame 
{
	...
	private void initComponents()
	{
		...
		// Aufbau des Menüs (die Einträge "Ändern" & "nach Kosen" waren nicht Teil der pLUe)

		JMenuItem hinzufuegen = new JMenuItem("Hinzufügen"); hinzufuegen.setMnemonic('H');
		JMenuItem aendern  = new JMenuItem("Ändern"); aendern.setMnemonic('e');
		JMenuItem loeschen = new JMenuItem("Löschen"); loeschen.setMnemonic('L');
		
		JMenu uebersicht = new JMenu("Übersicht sortiert"); uebersicht.setMnemonic('s');
