...
{
	/** mögliche Werte für das Auflösen von Wahlversprechen" */
	...
	// (Enumeration wäre schöner, haben wir aber nicht gelernt)
	...
	private float kosten;           // in € (nur hier, bei der PLÜ nicht in der Angabe!)
	...
	/**
	 * @param schlagwort eindeutiger, kurzer Text, darf nicht leer sein und kann nachträglich nicht geändert werden
	 ...
	 * @throws WahlversprechenException wenn kein gültiger Prozentwert
	 */
	...
	/**
	 * @param kosten in Mio.€, beliebiger (auch negativer) Wert möglich
	 */
	...
	/**
	 * @return wirdVerworfen mögliche Rückgabewerte: Wahlversprechen.SOFORT, 
	 ...
	 *        zulässige Werte: Wahlversprechen.SOFORT, 
	 *                         Wahlversprechen.IN_1_WOCHE, 
	 *                         Wahlversprechen.IN_1_MONAT, 
	 *                         Wahlversprechen.IN_1_JAHR
	 * @throws WahlversprechenException wenn keiner der vier zulässigen Texte (Zeiträume) angegeben wird
	 */
	public void setWirdVerworfen(String wirdVerworfen) throws WahlversprechenException
	{
		if (wirdVerworfen==null || !(wirdVerworfen.equals(Wahlversprechen.SOFORT)     ||  
			...
			throw new WahlversprechenException("Es muss ein gültiger Zeitraum für das Auflösen des Wahlversprechens angegeben werden!");
	...
	public void setGueltig(boolean gueltig, String ausrede) throws WahlversprechenException
	{
		if (!gueltig && (ausrede==null || ausrede.isEmpty()))
			throw new WahlversprechenException("Für ein verworfenes Wahlversprechen muss eine Ausrede angegeben werden!");
	...
	public String toString()
	{
		return "Schlagwort: " + schlagwort + ", Beschreibung: " + beschreibung 
				...
				+ "€, noch gültig: " + ((gueltig)?"ja":"nein") + ", wird verworfen: " + wirdVerworfen 
	...
	/* vergleich bezüglich Schlagwort
	 */
	@Override
